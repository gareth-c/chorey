    ...
    <div className="space-y-4">
            ...
            >
              ...
              <p
                className={`mt-0.5 text-sm font-semibold ${
                  day.isFuture ? "text-slate-300 dark:text-slate-600" : "text-slate-900 dark:text-white"
                }`}
              >
      ...
      {pastWeeks.length > 0 && (
        <div>
          ...
          <div className="divide-y divide-slate-100 rounded-xl border border-slate-200 bg-white dark:divide-white/10 dark:border-white/10 dark:bg-white/5">
            {pastWeeks.map((week) => (
              <div
                key={week.weekStart}
